    ...
    render() {
        return (
            <div className="carousel" data-flickity='{ "lazyLoad": 2, "autoPlay": true, "imagesLoaded": true, "wrapAround": true, "adaptiveHeight": true }'>
                ...
                <div className="carousel-cell">
                    <a href="/ads/slider_ads/6283CHR11.png" data-fancybox="slider-group" data-caption="Slider Image">
                ...
                <div className="carousel-cell">
                    <a href="/ads/slider_ads/9565CHSP.png" data-fancybox="slider-group" data-caption="Slider Image">
