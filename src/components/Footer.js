        ...
        <div className="Footer info">
            ...
            <div className="aside follow">
                ...
                <div className="qr-wrapper">
                    <img className="qr-image" src="./image/QR/qr_facebook.png" alt="facebook @SingTaoLA" />
                    <img className="qr-image" src="./image/QR/qr_weibo.png" alt="weibo @SingTaoDaily" />
                    <img className="qr-image" src="./image/QR/qr_wechat.png" alt="wechat @SingTaoLosAngeles" />
                </div>
            </div>
        </div>
